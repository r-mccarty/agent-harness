...
> **Reminder**: Template changes are local until you push them to Coder. After editing `templates/opticworks-dev/`, run:
>
> ```bash
> scp -r templates/opticworks-dev n100:/home/claude-temp/coder-templates/
...
> ```
>
> Skip this step and new workspaces will continue using the old template.
